...
if (isset($_SESSION["usuario"])) {
    if (isset($_POST["txtClave"]) && isset($_POST["txtOpe"])) {
        ...
        if ($bExito) {
            if ($sOpe == "a") {
                header("Location: crudusuario.php?agregado=1");
            } elseif ($sOpe == "m") {
                header("Location: crudusuario.php?modificado=1");
            } elseif ($sOpe == "b") {
                header("Location: crudusuario.php?eliminado=1");
            }
            exit();
...
<section>
    ...
    <form name="CreacionContacto" action="CreacionContacto.php" method="post">
        ...
        <input type="submit" value="Cancelar" onclick="CreacionContacto.action='crudcontactos.php';">
    </form>
</section>
